...
describe("LazyList", () => {
  ...
  describe("#cons", () => {
    ...
    it("should generate an N-elements list, when deep nested", () => {
      let lazyList = nil();
      for (let i = 9; i >= 0; i--) lazyList = cons(i, lazyList);
  ...
  describe("#except", () => {
    ...
    it("should filter out a group of element from a lazy list, based on a predicate", () => {
      ...
      const lazyListWithoutEvenElementsValues = [
        ...lazyListWithoutEvenElements()
      ];
    ...
    it("should filter out nothing, when the predicate is never satified", () => {
      ...
      const lazyListWithAllTheElementsValues = [
        ...lazyListWithAllTheElements()
      ];
    ...
    it("should be chainable with other #except", () => {
      const lazyListWithout2And3 = except(
        x => x == 3,
        except(x => x == 2, lazyList)
      );
  ...
  describe("#withValue", () => {
    ...
    it("should be chainable with other #withValue, on non-overlapping conditions", () => {
      const lazyListWith2And3Replaced = withValue(
        x => x == 3,
        33,
        withValue(x => x == 2, 22, lazyList)
      );
    ...
    describe("#tail", () => {
      ...
      it("should be chainable with other #tail", () => {
        const lazyListWithoutFirstTwo = tail(tail(lazyList));
